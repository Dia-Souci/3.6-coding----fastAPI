...
class YoloV8ImageObjectDetection:
    PATH        = os.path.join('..', 'model', 'best.pt')
    print(PATH)   # Path to a model. yolov8n.pt means download from PyTorch Hub
    CONF_THRESH = float(os.environ.get("YOLO_CONF_THRESHOLD", "0.15")) # Confidence threshold
